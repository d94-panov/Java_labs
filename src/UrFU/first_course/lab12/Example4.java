...
//Пример 4 Чтение из одного файла и запись в другой файл данных
//построчно с использованием буферизации символьных потоков
...
// Создание потоков для чтения и записи с нужной кодировкой
            ...
            bw = new BufferedWriter(
                    new OutputStreamWriter(
                            new FileOutputStream("C:\\Users\\dpabe\\IdeaProjects\\untitled\\src\\UrFU\\first_course\\lab12\\MyFile2.txt"), "cp1251"));
